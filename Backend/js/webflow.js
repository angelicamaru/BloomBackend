...
! function () {
    ...
    n.typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        var D = e.frame = function () {
            ...
            R = f(function (e) {
                ...
                function d(t, e, r) {
                    var o, a, s, u, c = e !== p,
                        l = {};
                    for (o in t) s = t[o], o in J ? (l.transform || (l.transform = {}), l.transform[o] = s) : (b.test(o) && (o = n(o)), o in Q ? l[o] = s : (u || (u = {}), u[o] = s));
                    for (o in l) {
                ...
                e.init = function (e) {
                    ...
                    $.backface && G.hideBackface && U(this.el, $.backface.css, "hidden")
                }, g("add", i), g("start", r), g("wait", function (t) {
                ...
                }), g("next", o), g("stop", a), g("set", function (t) {
                    a.call(this, t), d.call(this, t, v, w)
                }), g("show", function (t) {
                    "string" != typeof t && (t = "block"), this.el.style.display = t
                }), g("hide", s), g("redraw", f), g("destroy", function () {
            ...
            N = f(function (t) {
                ...
                t.init = function (t, e, i, r) {
                    ...
                    var a = e[0];
                    i[2] && (a = i[2]), Z[a] && (a = Z[a]), this.name = a, this.type = i[1], this.duration = u(e[1], this.duration, o.duration), this.ease = n(e[2], this.ease, o.ease), this.delay = u(e[3], this.delay, o.delay), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = T.test(this.name), this.unit = r.unit || this.unit || G.defaultUnit, this.angle = r.angle || this.angle || G.defaultAngle, G.fallback || r.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + z + this.duration + "ms" + ("ease" != this.ease ? z + h[this.ease][0] : "") + (this.delay ? z + this.delay + "ms" : ""))
                }, t.set = function (t) {
        ...
        e.fallback = function (t) {
            if (!$.transition) return G.fallback = !0;
            G.agentTests.push("(" + t + ")");
        ...
        $.transform && (Q.transform = [C], J = {
            ...
            skewX: [_],
            skewY: [_]
        }), $.transform && $.backface && (J.z = [k, "translateZ"], J.rotateZ = [_], J.scaleZ = [g], J.perspective = [x]);
        var V = /ms/,
            K = /s|\./;
        return t.tram = e
    }(window.jQuery);
    var i = {},
        ...
        a = t(function (t) {
            function e(t) {
                f.env() && (b(t.design) && m.on("__wf_design", t.design), b(t.preview) && m.on("__wf_preview", t.preview)), b(t.destroy) && m.on("__wf_destroy", t.destroy), t.ready && b(t.ready) && n(t)
            }

            function n(t) {
                x ? t.ready() : g.contains(d, t.ready) || d.push(t.ready)
            }

            function r(t) {
                b(t.design) && m.off("__wf_design", t.design), b(t.preview) && m.off("__wf_preview", t.preview), b(t.destroy) && m.off("__wf_destroy", t.destroy), t.ready && b(t.ready) && a(t)
            }
            ...
            function s(t, e) {
                var n = [],
                    i = {};
                return i.up = g.throttle(function (t) {
                    g.each(n, function (e) {
                        e(t)
                    })
            ...
            function l() {
                O && (O.reject(), m.off("load", O.resolve)), O = new v.Deferred, m.on("load", O.resolve)
            }
            var f = {},
                h = {},
                d = [],
            ...
            var _ = navigator.userAgent.toLowerCase(),
                ...
                T = f.env.chrome = /chrome/.test(_) && /Google/.test(navigator.vendor) && parseInt(j.match(/chrome\/(\d+)\./)[1], 10),
                z = f.env.ios = /(ipod|iphone|ipad)/.test(_);
            f.env.safari = /safari/.test(_) && !T && !z;
            var A;
            ...
            f.resize = s(m, M), f.scroll = s(m, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), f.redraw = s(), f.location = function (t) {
                ...
                x = !0, k ? c() : g.each(d, u), g.each(p, u), f.resize.up()
            };
            var O;
            f.load = function (t) {
                O.then(t)
            }, f.destroy = function (t) {
                t = t || {}, k = !0, m.triggerHandler("__wf_destroy"), null != t.domready && (x = t.domready), g.each(h, r), f.resize.off(), f.scroll.off(), f.redraw.off(), d = [], p = [], "pending" === O.state() && l()
    ...
    t(function (t) {
        ...
        e.define("forms", t.exports = function (t, n) {
            ...
            function r(e, n) {
                ...
                r.handler = null, r.redirect = i.attr("data-redirect"), T.test(s) ? r.handler = f : s || (v ? r.handler = l : z())
            }

            function o() {
                m = !0, b.on("submit", x + " form", function (e) {
                    var n = t.data(this, x);
            ...
            function f(e) {
                ...
                var i = e.form,
                    r = {};
                if (!/^https/.test(g.href) || /^https/.test(e.action)) {
                    d(e);
                    var o = u(i, r);
                    if (o) return j(o);
                    s(e);
            ...
            var p, v, m, w = {},
                ...
                z = n.debounce(function () {
                    j("Oops! This page has improperly configured forms. Please contact your website administrator to fix this issue.")
                }, 100);
        ...
        var e = s;
        e.define("gplus", t.exports = function (t) {
            function n() {
